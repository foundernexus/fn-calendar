  ...
  return (
    <div className="mx-auto max-w-md py-16">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Enter your email to get started. If you haven&apos;t connected your
        calendar yet (Google or Microsoft), you&apos;ll do that next. We only
        ever ask to read your calendar and add events — never your email or
        contacts.
      </p>
      {errorMessage && (
